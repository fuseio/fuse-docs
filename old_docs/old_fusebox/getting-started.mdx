...
To use the FuseBox [SDK](/docs/developers/fusebox/sdk/README), you need to create an `API KEY` using the Fuse [Console](https://console.fuse.io/build) Tool by following the steps outlined in this guide.
