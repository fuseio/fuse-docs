...
If you have completed the UI guide for interacting with [ERC 721 NFTs using FuseBox](/docs/developers/tutorials/web-sdk/mint-erc721-aa-part2), this guide is no different in the nature of the UI. What is highlighted here is the difference between interacting with the ERC721 and ERC-1155 by parsing a TokenID for ERC-1155. For example, calling the `safeTransfer()` method:
