---
title: Key Smart Contracts
description: List of key smart contracts
sidebar_position: 2
---

This page lists key smart contracts that have been deployed within the Fuse ecosystem.
...
* Voting - Fuse: 0x4c889f137232E827c00710752E86840805A70484
...
Do not send funds directly to the bridge contracts. Please use [Voltage](https://voltage.finance/), or read the [manual](https://github.com/fuseio/fuse-docs/blob/c3de557b34437d389a85dba6ddffaadbe042fa8f/docs/basics/bridge/bridge-to-fuse.mdx).
