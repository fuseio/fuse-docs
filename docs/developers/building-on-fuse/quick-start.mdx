...
[FuseBox](../fusebox) is an Open-Source Wallet-as-a-Service platform based on Account Abstraction. It is ERC-4337 compliant and allows developers to use a Bundler to collect UserOperations and a Paymaster to sponsor Gas payments for their users, enabling a Gasless experience.
...
- [Send Native/ERC20 Transactions](../fusebox/sdk/send-single-txn)
- [GET List of Tokens Owned by Address](../fusebox/sdk/get-list-of-tokens-owned-by-address)
