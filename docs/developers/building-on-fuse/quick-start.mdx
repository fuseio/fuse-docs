...
- [Remix](../web3-tools/using-remix-and-metamask)
- [Hardhat](../web3-tools/using-hardhat)
- [ThirdWeb](../web3-tools/using-thirdweb)

After writing a Smart Contract to deploy to the Fuse Blockchain, developers must add the Fuse Network to MetaMask. You can add Fuse Network to MetaMask using the following [guide](../../basics/overview/connect-to-fuse).
...
[FuseBox](/docs/developers/fusebox/fusebox) is an Open-Source Wallet-as-a-Service platform based on Account Abstraction. It is ERC-4337 compliant and allows developers to use a Bundler to collect UserOperations and a Paymaster to sponsor Gas payments for their users, enabling a Gasless experience.
...
- [Send Native/ERC20 Transactions](/docs/developers/fusebox/sdk/3-send-single-txn)
- [GET List of Tokens Owned by Address](/docs/developers/fusebox/sdk/8-get-list-of-tokens-owned-by-address)
...
Note: **SCW** is a _Smart Contract Wallet Address_.
