...
You can refer to the [document](/docs/developers/tutorials/validators/how-to-unjail-your-validator-node) to [unjail](/docs/developers/tutorials/validators/how-to-unjail-your-validator-node) your validator node.
