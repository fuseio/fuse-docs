...
The end point that we will use in this tutorial is the [Get Non Fungible NFT Token Balances](/api-reference/nft-tokens/get-non-fungible-nft-token-balances).
