...
Smart Wallets API provides a Wallets as a Service (WaaS) API for your cross-platform applications. As a developer, you can access the Smart Wallets API via the [fuse-sdk](../fuse-sdk/ 'mention') or refer to the [Smart Wallets API reference](../../smart-wallet-api/smart-wallets-api.tag.mdx) directly.&#x20;
...
Once you have your project set and access to your Public API key, you can start working with the Smart Wallets API. Check out the [Smart Wallets API Reference](../../smart-wallet-api/smart-wallets-api.tag.mdx) for usage.
