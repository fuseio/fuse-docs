...
In the following sections, we will cover how to get started with FuseBox, an overview of its Architecture, and the various Tools. If you have any questions or feedback, please get in touch with our support team at **[support@](mailto\:support@chargesmartwallets.com)\*\*\*\*[fuse.io](http://fuse.io).**
...
* A Wallet Service Provider such as MetaMask or Coinbase
* Fuse Tokens in your Externally Owned Account (EOA). You can buy Fuse Tokens in the [Console](https://console.fuse.io) / You can also use the [Bridge](https://console.fuse.io/bridge) to move over assets from other blockchains.
...
{/* TODO: image /img/console/welcome.png missing */}

## Step 2: Click the button “Connect Wallet”

{/* TODO: image /img/console/connect-wallet.png missing */}
...
{/* TODO: image /img/console/wallet-balance.png missing */}
...
{/* TODO: image /img/console/operator-landing.png missing */}

## Step 4: Click the button “Create Operator Wallet”

{/* TODO: image /img/console/operator-dashboard.png missing */}

Sign the message prompt from your Wallet Service Provider.

{/* TODO: image /img/console/sign-message.png missing */}

Fill in your details.

{/* TODO: image /img/console/contact-details.png missing */}

You have successfully created an Operator Account! Congratulations.

{/* TODO: image /img/console/congratulations.png missing */}

## Step 5: Fund the Operator Account

{/* TODO: image /img/console/operator-add-funds.png missing */}
...
{/* TODO: image /img/console/operator-balance.png missing */}

After you have funded the Operator Account with at least 10 Fuse Tokens, you can then access the API Key.

{/* TODO: image /img/console/operator-dashboard-final.png missing */}
