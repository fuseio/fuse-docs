...
The following code initializes the Fuse SDK and creates an instance of the `SmartWalletsSDK` class. The `publicApiKey` variable should be set to your own API key.
