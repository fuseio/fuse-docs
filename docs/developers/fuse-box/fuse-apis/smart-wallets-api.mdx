...
Before working with API, if you haven't done so, please follow the guide [Getting Started](../fuse-box/flutter-sdk).
...
| `Create Wallet`              | /api/v1/smart-wallets/create         | POST |
| `Get Wallet`                 | api/v1/smart-wallets                 | GET  |
| `Get Wallet Actions`         | /api/v2/smart-wallets/actions        | GET  |
| `Get Historical Transaction` | /api/v1/smart-wallets/historical_txs | GET  |
