...
To use the FuseBox [Web SDK](../fuse-box/fuse-sdk) or [Flutter SDK](../fuse-box/flutter-sdk), you need to create an `API KEY` using the Fuse [Console](https://console.fuse.io) Tool by following the steps outlined in this guide.
