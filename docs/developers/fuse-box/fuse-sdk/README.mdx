...
2. [Getting Started](#getting-started)
   - [Initializing a Smart Contract Wallet](#importing-fusebox-web-sdk)
   - [Initializing FuseBox](#initializing-fusebox)
...
### Initializing FuseBox<a name="initializing-fusebox"></a>
...
Replace 'YOUR_API_KEY' with your actual API key obtained from the Fuse Dashboard.
