...
### 1. FuseBox [JavaScript SDK](../fuse-box/fuse-sdk) for Web

Integrate Fuse seamlessly into your web applications using the FuseBox JavaScript SDK. This SDK provides easy-to-use functions and utilities to interact with the Fuse blockchain, allowing you to build decentralized features into your existing projects.

**Get started with FuseBox JavaScript SDK:**
[Tutorial: Send your first Transaction](../../tutorials/tutorials/send-your-first-transaction)

### 2. FuseBox [Flutter SDK](../fuse-box/flutter-sdk) for Mobile
