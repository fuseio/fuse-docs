...
Do not send funds to the bridges, use [Voltage](https://voltage.finance) or read the [manual](../../basics/getting-started-with-fuse/asset-bridges-to-other-chains.md)
