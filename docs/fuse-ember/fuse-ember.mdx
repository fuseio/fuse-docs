---
title: Introducing The Future Of Fuse
sidebar_position: 0
---
...
Fuse Ember will feature a number of upgrades to the network’s tokenomics to enhance security and increase sustainability.

* The staking limit for validators will increase from 5 million to 10 million FUSE
* The maximum inflation rate will be capped at 3% per year, reducing to zero after five years
* Base fees will be burned to introduce deflationary pressure

50,000 Node Licenses will be sold as NFTs. These give holders the right to run a validating node, or to delegate their rights to other node operators. As NFTs, the licenses can be bought and sold on the secondary market.
