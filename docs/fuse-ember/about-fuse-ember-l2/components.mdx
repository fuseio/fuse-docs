...
To operate a DAC node on Ember Chain, participants must [obtain a "node license"](/fuse-ember/fuse-ember/node-sale). These licenses grant the holder the right to operate a DAC node and earn rewards for their contribution to the network.
