...
Find out more: [https://ethereum.org/en/developers/docs/scaling/validium/](https://ethereum.org/en/developers/docs/scaling/validium/)

#### Ember DA node

To operate a DAC node on Ember Chain, participants must [obtain a "node license"](https://docs-staging.fuse.io/fuse-ember/Tokenomics/Node-Sale). These licenses grant the holder the right to operate a DAC node and earn rewards for their contribution to the network.
