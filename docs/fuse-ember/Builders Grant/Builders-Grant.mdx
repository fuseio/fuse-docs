...
The final amount of each grant will be determined by the panel, and will **not exceed $15,000** in FUSE tokens. **Additional awards of up to $5,000** in FUSE are available for builders who incorporate the following into their projects:
