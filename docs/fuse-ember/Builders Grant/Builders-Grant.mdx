...
For this reason, funds will only be disbursed to projects after they have deployed their software on Fuse Ember mainnet, once the blockchainplatform has gone live.
