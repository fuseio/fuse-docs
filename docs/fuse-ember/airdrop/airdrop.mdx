...
To incentivize the migration from L1 Fuse Network to the new L2 Fuse Ember chain, Fuse will be airdropping a total of **10.4 million FUSE** tokens to different platform stakeholders. The campaign will include four phases, with tokens being distributed using a points system for users and developers:
...
For the user-focused campaign phases #1 and #3, a system of vesting and burning has been designed to prevent the sudden release of large amounts of FUSE into the circulating supply, which could create downwards pressure on the token price.
