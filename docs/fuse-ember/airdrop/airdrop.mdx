...
Ember Flow is a new grants program by Fuse Network. This initiative is designed to accelerate developer adoption, user growth, and long-term retention across the ecosystem. Through Flow Points, developer teams can earn rewards for building apps that drive meaningful on-chain and social engagement.
...
A higher weight means greater influence for final Flow Point scores.
