...
Ember Flow is Fuse Network’s new grants program. It's designed to accelerate app development, user growth, and long-term engagement on Fuse. The program rewards developer teams through a points-based system - Flow Points - that can be redeemed for FUSE tokens.
