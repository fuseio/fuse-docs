...
As of June 2025, Fuse Network’s Treasury holds approximately 136,812,240 $FUSE. This document gives a full breakdown of the Treasury, with the aim of building trust by providing greater transparency about the project's use of these reserves to support our long-term vision of fostering decentralized financial ecosystems.
...
* Allocation: 24,695,833 $FUSE, locked until 2028 with a one-year cliff.
...
* Allocation: 50,355,136 $FUSE, locked until 2028 with a one-year cliff.
...
* Allocation: 19,095,049 $FUSE + 7,071,123 $FUSE (from Node Sale) = 26,166,172 $FUSE.
...
![](/img/treasury-pie.png)

You can find out more about Fuse Ember's tokenomics here: [https://docs-staging.fuse.io/fuse-ember/fuse-ember/tokenomics](https://docs-staging.fuse.io/fuse-ember/fuse-ember/tokenomics)
