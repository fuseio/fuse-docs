---
title: How to become a validato
---
...
* See [_Running a validator node_](getting-started-as-a-validator-on-fuse-mainnet.mdx)__
...
[You can delegate your Fuse token to a validator](../participating-in-network-consensus/stake-delegate-and-withdraw.mdx) of your choosing. Not everybody that wants to earn rewards needs to be a validator! Any token holder can delegate their Fuse token to a validator to earn rewards through the validator.
