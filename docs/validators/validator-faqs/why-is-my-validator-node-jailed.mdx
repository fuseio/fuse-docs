...
* As part of the [FIP11](https://github.com/fuseio/FIPs/blob/master/FIPS/fip-11.mdx), jailing was introduced when a validator node misbehaved and became offline.&#x20;
...
* [FIP11](https://github.com/fuseio/FIPs/blob/master/FIPS/fip-11.mdx) introduced the auto-removal of an offline validator node from the pending validator list and added a jailing period depending on the node's offline cycles.&#x20;
...
* For full details about the strike system and jail time period, look at the [FIP11](https://github.com/fuseio/FIPs/blob/master/FIPS/fip-11.mdx).
...
{% embed url="https://github.com/fuseio/FIPs/blob/master/FIPS/fip-11.mdx" %}
