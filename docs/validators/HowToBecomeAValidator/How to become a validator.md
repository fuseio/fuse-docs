...
Every 5 seconds, the network groups the latest transactions broadcasted to the system, validates them, and signs them so they can never be changed in the future.
...
Validators contribute their computer resources to maintain the network and need to have technical knowledge in hosting this kind of software (see Running a validator node) and participate in the network governance through voting.
