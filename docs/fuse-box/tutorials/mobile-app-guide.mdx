...
- An API Key from [Console](https://console.fuse.io)
...
Install the required dependencies [fuse_wallet_sdk](https://pub.dev/packages/fuse_wallet_sdk)
...
_**Note: If you are experiencing problems, open the `macos` directory, open `Runner` and open the `DebugProfile.entitlements` add the line:**_
