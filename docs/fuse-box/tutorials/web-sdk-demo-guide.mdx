---
title: FuseBox Web SDK Demo App - Smart Contract Wallet, Transfer Token and View Balance 
sidebar_position: 11
---
...
<img src="/img/tutorials/demo-app.png" width="100%" height="50%" />
...
const transferToken = async() => {
  ...
  ethers.parseUnits(amountValue, 6)
...
<img src="/img/tutorials/demo-app-final.png" width="100%" height="50%" />
