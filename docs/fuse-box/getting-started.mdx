...
- Fuse Tokens in your External Owned Account (EOA). You can buy Fuse Tokens in the [Console](https://console.fuse.io) / You can also use the [Bridge](https://console.fuse.io/bridge) to move over assets from other Blockchain.
