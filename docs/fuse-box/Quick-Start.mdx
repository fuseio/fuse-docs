...
You can use [Remix IDE](../basics/deploying-smart-contracts/using-remix-and-metamask), [Hardhat](../basics/deploying-smart-contracts/using-hardhat), or [ThirdWeb](../basics/deploying-smart-contracts/using-thirdweb) to deploy and test your smart contracts.
