...
You can use [Remix IDE](./deploying-smart-contracts/using-remix-and-metamask), [Hardhat](./deploying-smart-contracts/using-hardhat), or [ThirdWeb](./deploying-smart-contracts/using-thirdweb) to deploy and test your smart contracts.
