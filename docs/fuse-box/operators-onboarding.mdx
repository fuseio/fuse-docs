...
FUSE is available on several centralized (CEX) and decentralized DEX [exchanges](../../basics/intro-to-fuse/fuse_token#where-to-buy-fuse-token).
...
See RPC Node Providers [page](../developers/rpc).
