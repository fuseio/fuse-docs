...
**Faucet:** You can get Spark tokens for tests in minutes by making a request on [Spark Faucet](https://get.fusespark.io/). [https://get.fusespark.io/](https://get.fusespark.io/)
