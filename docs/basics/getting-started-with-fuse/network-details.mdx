...
**Faucet:** You can get Spark tokens for tests in minutes by making a request on the [ChainDrop faucet](https://chaindrop.org/?chainid=123\&token=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee "ChainDrop faucet").
