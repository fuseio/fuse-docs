...
The [FuseBox SDK](/docs/developers/fusebox/sdk/README) contains all the methods required for building a complete application on Fuse, with SDKs for both Flutter and JS. The FuseBox SDK simplifies the incorporation of Account Abstraction on the Fuse Blockchain, offering features such as:
...
- Join our [Discord](https://discord.com/invite/jpPMeSZ).
