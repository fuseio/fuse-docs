...
Fuse is preparing an updated tokenomics framework.
...
Fuse’s tokenomics are evolving:
...
As the network matures, Fuse is transitioning to a revenue-based, deflationary model — one that rewards real network usage rather than continuous token emissions.
...
A comprehensive updated Tokenomics Proposal is being developed and will include:
...
| New Network Incentives Pool | Multiple wallets                           | 26,166,172 $FUSE | Fuse incentives, grants, liquidity growth      |
