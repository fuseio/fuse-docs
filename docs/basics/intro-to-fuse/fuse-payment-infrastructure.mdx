...
1\) Client [SDKs](../../fuse-box/sdk).

2\) the FuseBox API-based platform.

3\) Smart contracts on Fuse Network that power smart contract wallets, tokens, fee abstraction, and other components used by (1) and (2).
