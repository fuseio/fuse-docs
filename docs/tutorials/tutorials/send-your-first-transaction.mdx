...
Running this code will display the smart account address in the console. Note that the smart account is counterfactual and will be deployed on-chain when you send a transaction. Go ahead and send some FUSE to this account so it can pay its gas.
