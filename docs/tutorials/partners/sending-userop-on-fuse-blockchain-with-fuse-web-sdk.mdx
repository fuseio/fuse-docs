...
const main = async () => {
  // Replace 'YOUR_PRIVATE_KEY' and 'API_KEY' with your actual private key and API key
...
Replace `'PRIVATE_KEY'` and `'API_KEY'` with your actual private key and API key from the Fuse Console.
...
const main = async () => {
  // Replace 'PRIVATE_KEY' and 'API_KEY' with your actual private key and API key
