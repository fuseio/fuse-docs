...
<h1 className={"openapi__heading"}>Smart Wallets API v2</h1>

Smart Wallets API provides a Wallets as a Service (WaaS) API for your cross-platform applications. Developers can also access the Smart Wallets API via the [fuse-sdk](/docs/developers/fuse-box/fuse-sdk/README.mdx).
...
Once you have your project set and access to your Public API key, you can start working with the Smart Wallets API. Check out the [Smart Wallets API V2 Reference](/docs/smart-wallet-v2-api/auth) for usage.
