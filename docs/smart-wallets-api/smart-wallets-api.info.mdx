...
Once you have your project set and access to your Public API key, you can start working with the Smart Wallets API. Check out the [Smart Wallets API V2 Reference](/docs/smart-wallets-api/auth) for usage.
